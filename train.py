...
def init_project():
    ...
    if not os.path.isdir('/mydrive/MyDrive/deformable/deformable_hwt/saved_images'): os.mkdir('/mydrive/MyDrive/deformable/deformable_hwt/saved_images')
    if not os.path.isdir('/mydrive/MyDrive/deformable/deformable_hwt/saved_models'): os.mkdir('/mydrive/MyDrive/deformable/deformable_hwt/saved_models')
    if os.path.isdir(os.path.join('/mydrive/MyDrive/deformable/deformable_hwt/saved_images', EXP_NAME)): shutil.rmtree(os.path.join('/mydrive/MyDrive/deformable/deformable_hwt/saved_images', EXP_NAME))
    os.mkdir(os.path.join('/mydrive/MyDrive/deformable/deformable_hwt/saved_images', EXP_NAME))
    os.mkdir(os.path.join('/mydrive/MyDrive/deformable/deformable_hwt/saved_images', EXP_NAME, 'Real'))
    os.mkdir(os.path.join('/mydrive/MyDrive/deformable/deformable_hwt/saved_images', EXP_NAME, 'Fake'))
...
MODEL_PATH = os.path.join('/mydrive/MyDrive/deformable/deformable_hwt/saved_models', EXP_NAME)
